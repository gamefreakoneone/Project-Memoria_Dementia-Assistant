...
class video_results(BaseModel):
    video_description: str = Field("This is the video description of the video, where all the actions of the person in the video are described in detail.")
    room_objects: list[str] = Field("List of objects present in the video which the user interacted with, or have added to environment and is still in the room and not removed from the scene.")
...
print(test_agent.video_description(r"Storage\video_recordings\camera_1\camera_1_20260102_182147.mp4"))
